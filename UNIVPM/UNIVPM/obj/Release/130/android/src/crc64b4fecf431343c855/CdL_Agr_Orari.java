...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("UNIVPM.CdL_Agr_Orari, UNIVPM", CdL_Agr_Orari.class, __md_methods);
	}


	public CdL_Agr_Orari ()
	{
		super ();
		if (getClass () == CdL_Agr_Orari.class) {
			mono.android.TypeManager.Activate ("UNIVPM.CdL_Agr_Orari, UNIVPM", "", this, new java.lang.Object[] {  });
		}
	}
