...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("UNIVPM.Seg_Scie, UNIVPM", Seg_Scie.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == Seg_Scie.class) {
			mono.android.TypeManager.Activate ("UNIVPM.Seg_Scie, UNIVPM", "", this, new java.lang.Object[] {  });
		}
	}
